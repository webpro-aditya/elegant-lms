...
<div>
    <div class="main_content_iner main_content_padding">
                                            ...
                                            <div class="payment_method_single">
                                                <div
                                                    ...
                                                    @if($gateway->method=="Stripe")
                                                        <form
                                                            action="{{route('membership.membershipLevelUpdatePaymentSubmit')}}"
                                                            method="post">
                                                            ...
                                                            <input
                                                                value="{{ convertCurrency(Settings('currency_code') ??'BDT', 'USD', $planLevel->price)}}"
                                                                readonly="readonly"
                                                                type="hidden"
                                                                id="amount"
                                                                name="amount">
                                                            ...
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            @php
                                                                                $total_amount =$planLevel->price;
                                                                                $route =route('membership.membershipLevelUpdatePaymentSubmit');
                                                                ...
                                                                <div
                                                                    ...
                                                                    <form
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value="Wallet"
                                                                            id="balanceInput"
                                                                            style="display: {{$user->balance >=$planLevel->price?'':'none'}}"
                                                                            class="method"
                                                                            type="hidden">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <input
                                                                                        ...
                                                                                        name="amount"
                                                                                        class="primary_input3"
                                                                                        value="{{getPriceFormat($planLevel->price)}}"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            @if ($user->balance >= $planLevel->price)
                                                                                <button
                                                                                    class=" theme_btn"
                                                                                    type="submit">
                                                                                    @lang('common.Pay')
        ...
        <div class="order_wrapper">
            <h3 class="font_22 f_w_700 mb_30">{{__('frontend.Update Your Plan Level')}}</h3>
            ...
            <div class="ordered_products_lists">
                ...
                <div class="single_lists">
                    ...
                    <span class="totalBalance"> {{getPriceFormat($planLevel->price)}}</span>
