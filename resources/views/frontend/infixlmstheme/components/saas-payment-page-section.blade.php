                                    ...
                                    @if(isset($methods))
                                        ...
                                        margin-top: -9px;"
                                                            ...
                                                            <script
                                                                ...
                                                                class="stripe-button"
                                                                data-key="{{ getMainPaymentEnv('STRIPE_KEY') }}"
                                                            ...
                                                            <input
                                                                value="{{ convertCurrency(Settings('currency_code') ??'BDT', 'USD', $plan->price)}}"
                                                                readonly="readonly"
                                                                type="hidden"
                                                                id="amount"
                                                                name="amount">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            @php
                                                                                ...
                                                                                $route =route('saasSubmit');
                                                                                 $payment_type ='LmsSaas'
                                                                            @endphp
                                                                            <div class="col-md-12">
                                        ...
                                        margin-top: -2px;"
                                                                    ...
                                                                    <script
                                                                        ...
                                                                        data-key="{{ getMainPaymentEnv('RAZOR_KEY') }}"
                                                                        data-amount="{{ convertCurrency(Settings('currency_code') ??'BDT', 'INR', $plan->price)*100}}"
