                                    ...
                                    <div class="single_course_cat">
                                        <div class="icon">
                                            @if(!empty($homeContent->key_feature_logo1))
                                                <img
                                                    src="{{assetPath($homeContent->key_feature_logo1)}}"
                                                    alt="">
                                            @endif
                                        </div>
                                    ...
                                    <div class="single_course_cat">
                                        <div class="icon">
                                            @if(!empty($homeContent->key_feature_logo2))
                                                <img
                                                    src="{{assetPath($homeContent->key_feature_logo2)}}"
                                                    alt="">
                                            @endif
                                        </div>
                                        <div class="course_content">
                                    ...
                                    <div class="single_course_cat">
                                        <div class="icon">
                                            @if(!empty($homeContent->key_feature_logo3))
                                                <img
                                                    src="{{assetPath($homeContent->key_feature_logo3)}}"
                                                    alt="">
                                            @endif
                                        </div>
                                        <div class="course_content">
                                ...
                                @if($key==0)
                                    <div class="category_wiz mb_30">
                                        <div class="thumb cat1"
                                             style="background-image: url('{{assetPath($category->thumbnail)}}')">
