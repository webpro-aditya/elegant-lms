                                    ...
                                    @if(isset($methods))
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <input
                                                                                        ...
                                                                                        {{Settings('currency_symbol') ??'৳'}} 0  @else   {{getPriceFormat(Auth::user()->balance)}}
                                                                                        @endif"
                                                                                        readonly>
                                                                                </div>
                                                                                <div
                                        ...
                                        margin-top: -2px;"
                                                    ...
                                                    @elseif($gateway->method=="PayTM")
                                                        @includeIf('paytm::paytm_btn',['type'=>'subscription','amount'=>$checkout->purchase_price])
                                        ...
                                        margin-top: -6px;"
                                                    ...
                                                    @elseif($gateway->method == 'Mollie')
                                                        @includeIf('mollie::subscription',['gateway' => $gateway])
                                                    @elseif($gateway->method == 'Authorize.Net')
                                                        @includeIf('authorizenet::subscription',['gateway' => $gateway])
                                                    @elseif($gateway->method == 'Braintree')
                                                        @includeIf('braintree::subscription',['gateway' => $gateway])

                                                    @elseif($gateway->method == 'Flutterwave')
                                                        @includeIf('flutterwave::subscription',['gateway' => $gateway])

                                                    @elseif($gateway->method == 'Jazz Cash')
                                                        @includeIf('jazzcash::subscription',['gateway' => $gateway])
                                                    @elseif($gateway->method == 'Coinbase')
                                                        @includeIf("coinbase::subscription",['gateway' => $gateway])
                                                    @elseif($gateway->method == 'AmazonPayment')
                                                        @include("amazonpayment::_payment",['gateway' => $gateway, 'location' => 'subscription','amount'=>$checkout->purchase_price])
