        ...
        <div class="billing_details_wrapper">
            <div class="biling_address gray-bg">
                <div class="biling-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('ebookPlanCheckout', ['plan'=>$plan->id, 'type'=>'edit']) }}">{{ __('common.Edit') }}</a>
                </div>
                                            ...
                                            <div class="payment_method_single">
                                                <div class="deposite_payment_wrapper customer_payment_wrapper">
                                                    @if ($gateway->method == 'Stripe')
                                                        <form action="{{ route('ebookPlanPaymentSubmit') }}"
                                                              method="post">
                                                            ...
                                                            <input
                                                                ...
                                                                readonly="readonly" type="hidden" id="amount"
                                                                name="amount">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            @php
                                                                                ...
                                                                                $route = route('ebookPlanPaymentSubmit');
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLabel">
                                                                            {{ __('membership.Ebook Plan Submit') }}</h5>
                                                                    </div>
                                                                    <form
                                                                        action="{{ route('ebookPlanPaymentSubmit') }}"
                                                    ...
                                                    @elseif($gateway->method == 'PayStack')
                                                        <form action="{{ route('ebookPlanPaymentSubmit') }}"
                                                            ...
                                                            <input type="hidden" name="amount"
                                                                   value="{{ convertCurrency(Settings('currency_code') ?? 'BDT', Settings('currency_code'), 999) * 100 }}">
                                                            {{-- required in kobo --}}
