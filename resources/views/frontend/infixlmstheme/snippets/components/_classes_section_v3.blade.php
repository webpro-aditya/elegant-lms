<div data-type="component-text"
     data-preview="{{!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/class/3.jpg')}}"
     data-aoraeditor-title="Classes Section V3" data-aoraeditor-categories="Home Page;Classes">
