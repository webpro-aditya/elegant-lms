<div data-type="component-text"
     data-preview="{{!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/class/1.jpg')}}"
     data-aoraeditor-title="Classes Section V1" data-aoraeditor-categories="Home Page">
