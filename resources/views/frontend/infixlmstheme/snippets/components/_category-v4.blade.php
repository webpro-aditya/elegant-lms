<div data-type="component-text"
     data-preview="{{!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/categories/4.jpg')}}"
     data-aoraeditor-title="Category V4" data-aoraeditor-categories="Home Page;Categories">
