<div data-type="container"
     ...
     data-preview="{{!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/row_8_4.png')}}"
     data-aoraeditor-title="2 columns (67% - 33%)" data-aoraeditor-categories="2 columns">
    <div class="row">
