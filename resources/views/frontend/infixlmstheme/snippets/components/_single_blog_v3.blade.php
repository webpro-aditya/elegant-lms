        ...
        @foreach($result as $blog)
            <div class="blog-single bg-white">
                ...
                <div class="blog-single-rating">
                    <div
                        class="mb-4 p-2 d-flex align-items-center justify-content-between flex-wrap bg-white rounded-pill">
                        ...
                        <div class="date text-end">
                            <span
                                class="text-primary fw-500">{{ showDate(@$blog->authored_date ) }}</span>
                        </div>
                    </div>
                </div>
