<div data-type="component-text"
    ...
    <style>
        .counter_area::before {
            display: none;
            background-image: url('{{assetPath('frontend/infixlmstheme/img/about/counter_bg.png')}}');
        }
    ...
    <div class="counter_area">
        <div class="w-auto h-100 position-absolute bottom-0 right-0 ">
            <img class="w-auto h-100 img-cover d-none d-lg-block"
                 src="{{assetPath('frontend/infixlmstheme/img/about/counter_bg.png')}}" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
