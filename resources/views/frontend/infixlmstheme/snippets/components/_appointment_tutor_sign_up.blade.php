...
<div data-type="component-text" data-preview="{{assetPath('modules/appointment/keditor/snippets/preview/affiliate/become_instructor_sing_up.png')}}" data-keditor-title="Instructor FAQ" data-keditor-categories="Instructor FAQ">
