                ...
                <div class="col-lg-7 mb_30">
                    <div class="about_gallery">
                        <div class="gallery_box">
                            <div class="thumb">
                                <img class="w-100" src="{{assetPath($about_page->image1)}}" alt="">
                            </div>
                            <div class="thumb small_thumb">
                                <img class="w-100" src="{{assetPath($about_page->image2)}}" alt="">
                            </div>
                        </div>
                        <div class="gallery_box">
                            <div class="thumb">
                                <img class="w-100" src="{{assetPath($about_page->image3)}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
