<div data-type="component-text"
     data-preview="{{ !function_exists('themeAsset') ? '' : themeAsset('img/snippets/preview/price/2.jpg') }}"
     data-aoraeditor-title="Price V2" data-aoraeditor-categories="Price;Home Page">
    ...
    <div class="price section-margin-lg position-relative">
        <div class="container">
