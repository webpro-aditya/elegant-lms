...
<div class="fc-widget" id="fcWidget">
  <div class="fc-cards">
    ...
    <a href="https://wa.me/{{ Settings('floating_whatsapp') ?? '971566835512' }}" target="_blank" class="fc-card wa-card">
      <div class="fc-icon">
    ...
    <a href="mailto:{{ Settings('floating_email') ?? 'sales@elegant-training.ae' }}" class="fc-card email-card">
      <div class="fc-icon">
    ...
    <a href="tel:{{ Settings('floating_phone') ?? '+971566835512' }}" class="fc-card call-card">
      <div class="fc-icon">
        <svg viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
      </div>
      <div class="fc-info">
        <span class="fc-label">Talk to us now</span>
        <span class="fc-value">{{ Settings('floating_phone') ?? '+971566835512' }}</span>
      </div>
      <div class="fc-arrow"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="m9 18 6-6-6-6"/></svg></div>
    </a>
