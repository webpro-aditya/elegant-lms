@php
    $user =auth()->user();
@endphp
<div class="header_iner d-flex justify-content-between align-items-center gap-3">
            ...
            <ul>
                ...
                <li class="notification_open">
                    <a href="#" class="notify_icon">
                        <div class="notify_icon">
                            <img src="{{assetPath('frontend/infixlmstheme/img/svg/bell.svg')}}" alt="">
                            {{-- <i class="ti-bell"></i> --}}
                        </div>
                ...
                <li>
                    <a href="{{route('myWishlists')}}">
                        <div class="notify_icon">
                            <img src="{{assetPath('frontend/infixlmstheme/img/svg/heart.svg')}}" alt="">
                        </div>
                        @if(totalWhiteList()!=0)
                ...
                <li>
                    <a href="#" class="cart_store">
                        <div class="notify_icon">
                            <img class="" src="{{assetPath('frontend/infixlmstheme/img/svg/cart.svg')}}" alt="">
                        </div>
                        @if(cartItem()!=0)
                            <span class="notify_count "></span>
                        @endif
