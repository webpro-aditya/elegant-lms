<div class="modal fade admin-query admin_view_modal" id="viewAttachment{{$submitted->id}}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @if ($ext=='jpg' || $ext=='jpeg' || $ext=='png' || $ext=='heic')
                    <img class="img-responsive mt-20" style="width: 100%; height:auto" src="{{assetPath($attached_file)}}">
                @elseif($ext=='mp4' || $ext=='mov')
                    <video class="mt-20 video_play" width="100%" controls>
                        <source src="{{assetPath($attached_file)}}" type="video/mp4">
                        <source src="mov_bbb.ogg" type="video/ogg">
                        Your browser does not support HTML video.
                    </video>
                @elseif($ext=='mp3')
                    <audio class="mt-20 audio_play" controls style="width: 100%">
                        <source src="{{assetPath($attached_file)}}" type="audio/ogg">
                        <source src="horse.mp3" type="audio/mpeg">
                        Your browser does not support the audio element.
                    </audio>
                @elseif($ext=='pdf')
                    <object data='{{assetPath($attached_file)}}' type="application/pdf" width="100%" height="800">
                        <iframe src='{{assetPath($attached_file)}}' width="100%" height="800">
                ...
                <div class="mt-40 d-flex justify-content-between" style="margin-top: 40px;">
                    ...
                    @endphp
                    @if (fileExists($attached_file))

                        <a class="link_value theme_btn small_btn4" download="{{$set_filename}}"
                           href="{{assetPath($attached_file)}}"> <span
