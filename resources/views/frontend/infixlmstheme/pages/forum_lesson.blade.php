...
@endsection
@section('js')
    <script src="{{assetPath('frontend/infixlmstheme/js/forum.js')}}{{assetVersion()}}"></script>
@endsection
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div
                                                        ...
                                                        @else
                                                            <span
                                                                class="no-wrap">{{ \Carbon\Carbon::parse($forum->updated_at)->diffForhumans() }}</span>
                                                        @endif
                                                    </div>
                            ...
                            <div class="tab-pane fade" id="nav-contact" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table class="table fourm_table mb-0">
                                        <thead>
                                        <tr>
                                            <th class="ps-0">Most Viewed post
                                                @if(isset($course_info->id) && $course_info->IsLoginUserEnrolled)
                                                    <a href="{{route('forum.CreateLessonForum',[$course_info->id,$lesson_info->id])}}"><span
                                                            class="post_pin">New Post</span></a>
                                                @endif
