@if(!env('APP_SYNC'))
    <button data-bs-target="#revoke_theme_license_modal_{{ $name }}" data-bs-toggle="modal"
            class="  btn btn-sm btn-link ml-2">
        Revoke License
    </button>

    <div class="modal fade admin-query" id="revoke_theme_license_modal_{{ $name }}" data-bs-backdrop="static">
                        ...
                        <form method="post" action="{{ route('service.revoke.theme') }}" accept-charset="UTF-8"
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-center text-danger font-weight-bold" id="message-body">
                                    If you revoke your license, your theme data will be removed, Please take a backup of
                                    your
