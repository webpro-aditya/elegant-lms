                    ...
                    <div class="col-lg-12">
                        <div class="white_box mb_30">
                            <div class="white_box_tittle list_header main-title mb-0">
                                <h3 class="mb-0" id="page_title">{{__('courses.Advanced Filter')}} </h3>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 mt-20">
                                        ...
                                        <label class="primary_input_label"
                                               for="category">{{__('common.Users')}}</label>
                ...
                <div class="col-lg-12">
                    <div class="box_header">
                        <div class="main-title d-flex flex-wrap mb-0">
                            <h3 class="mb-0">{{__('report.User wise Performance')}}</h3>
                        </div>
                    </div>
                </div>
                @php
                    ...
                    if(!$type){
                          ...
                          request()->merge(['from'=>'user_wise']);
                          $type = 1;
                    }
                    $url = route('admin.userWisePerformance').'?'.http_build_query(request()->query());
                @endphp
