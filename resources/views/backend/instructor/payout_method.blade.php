                    ...
                    <div class="payment_methord">
                        ...
                        <div class="payment_mathord_content">
                            <div id="myTab" role="tablist" class="nav nav-tabs payment_methord_logo">
                                <a data-bs-toggle="tab" href="#paypal" role="tab"
                                   class="nav-link single_logo_iner active" aria-selected="true">
                                    <img src="{{asset('/public/')}}/uploads/payout/pay_1.png" alt="#">
                                </a>
                                <a data-bs-toggle="tab" href="#profile" role="tab" class="nav-link single_logo_iner"
                                   aria-selected="false">
                                    <img src="{{asset('/public/')}}/uploads/payout/pay_4.png" alt="#">
                                </a>
                                <a data-bs-toggle="tab" href="#swift" role="tab" class="nav-link single_logo_iner"
                                   aria-selected="false">
                            ...
                            <div id="myTabContent" class="tab-content">
                                <div id="paypal" role="tabpanel" class="tab-pane fade active show">
                                    <form role="form" method="post" action="{{route('save.userPayoutInfo')}}">
                                        ...
                                        <div class="form_group"><label for="email_address"></label> <input type="email"
                                                                                                           id="email_address"
                                                                                                           name="paypal_email"
                                ...
                                <div id="profile" role="tabpanel" class="tab-pane fade">
                                    <form role="form" method="post" action="{{route('save.userPayoutInfo')}}">
                                        ...
                                        <div class="form_group"><label for="email_address">Set paypal email
                                                address</label> <input type="email" id="email_address" name="paytmEmail"
                                ...
                                <div id="swift" role="tabpanel" class="tab-pane fade">
                                    <form role="form" method="post" action="{{route('save.userPayoutInfo')}}">
                                        ...
                                        <div class="form_group"><label for="email_address">Set stripe email
                                                address</label> <input type="email" id="email_address"
                                                                       name="stripeEmail" placeholder="Email Address">
                                        </div>
