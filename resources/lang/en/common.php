<?php
    ...
    "License" => "License",
    "Timestamp" => "Timestamp",
    "Recommend size" => "Recommend size",
    "Phone Number" => "Phone Number",
    "Gift this course" => "Gift this course",
    "Gift this Quiz" => "Gift this Quiz",
    "Gift this live class" => "Gift this live class",
    "Gift this quiz" => "Gift this quiz",
    "Invitation Sent successful" => "Invitation Sent successful",
    "No gift option" => "No gift option",
    "Api Key" => "Api Key",
    "Api Version" => "Api Version",
    "Webhook Secret" => "Webhook Secret",
    "Merchant ID" => "Merchant ID",
    "Integrity Salt" => "Integrity Salt",
    "LIVE" => "LIVE",
    "Pay via" => "Pay via",
    "Mollie" => "Mollie",
    ...
    "Referrer Users" => "Referrer Users",
    "New Registration" => "New Registration",
    "Bonus For" => "Bonus For",
    "Braintree" => "Braintree",
    "Gifted, Not Enrolled Yet" => "Gifted, Not Enrolled Yet",
    "Gifted but not enrolled" => "Gifted but not enrolled",
    ...
    "Sort by biggest" => "Sort by biggest",
    "KB" => "KB",
    "Selected Only" => "Selected Only",
    "Selected File" => "Selected File",
    "File Detail Info" => "File Detail Info",
    "Extension" => "Extension",
    "Size" => "Size",
    ...
    "Minimum 8 Letters" => "Minimum 8 Letters",
    "Note: 0 or empty means unlimited" => "Note: 0 or empty means unlimited",
    "Permission denied" => "Permission denied",
    "No Progress" => "No Progress",
    "day" => "Day",
    "month" => "Month",
    "year" => "Year",
    "Module File is missing, Please contact with administrator" => "Module File is missing, Please contact with administrator",
    ...
    'AM'=>'AM',
    'PM'=>'PM',
    'Already logged in as' => 'Already logged in as',
    'Expiration Date'=>'Expiration Date',
    'App Debug'=>'App Debug',
    'Force HTTPS'=>'Force HTTPS',
    'Bulk'=>'Bulk',
    'Students can not access course anymore'=>'Students can not access course anymore',
    'But not refund money to students'=>'But not refund money to students',
    'Sending invitation may take some time'=>'Sending invitation may take some time',
