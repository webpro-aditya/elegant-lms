...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 mb_30 col-md-2">
                            ...
                            <div class="col-12">
                                ...
                                <div class="primary_input mb_15">
                                    ...
                                    <select name="file_name" id="file_name"
                                        ...
                                        <option> {{ __('common.Choose File') }}</option>

                                        @php
                                            $files =scandir(base_path('resources/lang/default/'));
                                            $permission ='permission.php';
                                            if (!in_array($permission,$files)){
                                                array_push($files,$permission);
                                            }
                                        @endphp
                ...
                <div class="col-lg-9 col-md-10" id="" style="min-height: 500px">
                    <div id="translate_form"></div>
                    <div class="row justify-content-center mt-30 demo_wait" style="display: none">
                        <svg class="svg" version="1.1" id="L4" xmlns="http://www.w3.org/2000/svg"
...
@endsection
@push('scripts')
    <script src="{{assetPath('backend/js/language.js')}}"></script>
