<div class="row mb-10">
    ...
    <div class="col-lg-4">
        ...
        <ul class="d-flex">
            <li><a data-bs-toggle="modal" data-bs-target="#addFile" class="primary-btn radius_30px  fix-gr-bg" href="#"><i
                        class="ti-plus"></i>Add File</a></li>
        </ul>
    </div>
</div>
            ...
            <div class="modal-body">
                <form action="{{route('saveFile')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="primary_file_uploader">
                        <input class="primary-input" type="text" id="placeholderFileOneName" value=""
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 mt-20">
                            <div class="primary_input">
                                ...
                                <input class="primary_input_field" name="fileName" value=""
                                       placeholder="{{__('common.File')}} {{__('common.Name')}}" type="text">
                            </div>
                        </div>
                            ...
                            <div class="dropdown CRM_dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
                                    <a class="dropdown-item" data-bs-toggle="modal"
                                       data-bs-target="#editFile{{$exercise_file->id}}"
                                    ...
                                    <form action="{{route('updateFile')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="primary_file_uploader">
                                            <input class="primary-input" type="text" id="placeholderFileOneName"
                                                   value="" placeholder="{{showPicName(@$exercise_file->file)}}"
                                                   readonly="">
                                            <button class="" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                                       for="document_file_2">Browse</label>
                                                <input type="file" class="d-none" name="exercise_file"
                                                       id="document_file_2">
                                            </button>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 mt-20">
                                                <div class="primary_input">
                                                    {{-- <label class="primary_input_label" for=""> {{__('common.Name')}} </label> --}}
                                                    <input class="primary_input_field" name="fileName"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mt-40 d-flex justify-content-between">
                                        ...
                                        <form method="POST" action="{{ route('deleteFile') }}" enctype="multipart/form-data">
                                            @csrf                                        <input type="hidden" name="id" value="{{$exercise_file->id}}">
                                        <button class="primary-btn fix-gr-bg"
