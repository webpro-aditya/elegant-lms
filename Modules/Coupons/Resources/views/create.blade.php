                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="employee_id" class="primary_input_field name"
                                           placeholder="{{ __('common.Staff Id') }}" type="text" required>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="email" class="primary_input_field name"
                                           placeholder="{{ __('common.Email') }}" type="email" required>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="username" class="primary_input_field name"
                                           placeholder="{{ __('common.Username') }}" type="text" required>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="password" class="primary_input_field name"
                                           ...
                                           placeholder="{{ __('common.Password') }}" type="password" required>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="confirm_password" class="primary_input_field name"
                                           autocomplete="new-password"
                                           placeholder="{{ __('common.Re-Password') }}" type="password" required>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="phone" class="primary_input_field name"
                                           placeholder="{{ __('common.Phone') }}" type="tel" required>
                                </div>
                            </div>
