<div class="col-lg-3" @if(!isset($editdata)) style="display: none"@endif>
    ...
    <form class="form-horizontal"
          action="@if(isset($editdata)){{ route('zoom.meetings.update',$editdata->id) }}  @else {{ route('zoom.meetings.store') }}@endif"
          method="POST"
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12">
                            <div class="input-effect">
                                ...
                                <label class="primary_input_label mt-1">{{__('zoom.Topic')}} <span class="required_mark">*</span></label>
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12">
                            <div class="input-effect">
                                ...
                                <label class="primary_input_label mt-1">{{__('zoom.Description')}}</label>
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-6">
                            <label class="primary_input_label mt-1">{{__('zoom.Date Of Class')}} <span class="required_mark">*</span></label>
                        ...
                        <div class="col-lg-6">
                            <label class="primary_input_label mt-1">{{__('zoom.Time Of Class')}} <span class="required_mark">*</span></label>
                            <input
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    ...
                                    <label class="primary_input_label mt-1">{{__('zoom.Class Duration')}}<span class="required_mark">*</span></label>
                                    <span class="focus-border"></span>
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12">
                            <div class="input-effect">
                                ...
                                <label class="primary_input_label mt-1">{{__('zoom.Password')}}<span class="required_mark">*</span></label>
                                <span class="focus-border"></span>
                            ...
                            <div class="d-flex radio-btn-flex ml-20">
                                @if (isset($editdata))
                                    <div class="mr-20">
                                        ...
                                        <label for="recurring_options1">{{__('zoom.Yes')}}</label>
                                    </div>
                                    <div>
                                        ...
                                        <label for="recurring_options2">{{__('zoom.No')}}</label>
                                    </div>
                                @else
                                    <div class="mr-30">
                                        <input type="radio" name="is_recurring" id="recurring_options1"
                    ...
                    <div class="row mt-20 zoom-recurrence-section-hide">
                        <div class="col-lg-12">
                            <select
                    ...
                    <div class="row mt-30 zoom-recurrence-section-hide">
                        <div class="col-lg-12">
                            <label class="primary_input_label mt-1">{{__('zoom.Recurring End')}} *</label>
                    ...
                    <div class="row g-0  input-right-icon mt-30">
                        <div class="col">
                            <div class="input-effect">
                                <input
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12 d-flex">
                            <p class="text-uppercase fw-500 mb-10"
                            >{{__('zoom.Change Default Settings')}}</p>
                        </div>
                        <div class="col-lg-12 d-flex">
                            ...
                            <div class="d-flex radio-btn-flex ml-40">
                                <div class="mr-30 row">
                                    ...
                                    <label for="change_default_settings">{{__('zoom.Yes')}}</label>
                                </div>
                                <div class="mr-30 row">
                                    <input type="radio" name="chnage-default-settings"
                                           ...
                                           @if (!isset($editdata)) checked
                                           @endif  class="common-radio chnage-default-settings relationButton">
                                    <label for="change_default_settings2">{{__('zoom.No')}}</label>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="d-flex radio-btn-flex ml-40">
                                @if (isset($editdata))
                                    <div class="mr-30 row">
                                        ...
                                        <label for="metting_options1">{{__('zoom.Yes')}}</label>
                                    </div>
                                    <div class="mr-30 row">
                                        ...
                                        <label for="metting_options2">{{__('zoom.No')}}</label>
                                    </div>
                                @else
                                    <div class="mr-30 row">
                                        <input type="radio" name="join_before_host" id="metting_options1"
                            ...
                            <div class="d-flex radio-btn-flex ml-40">
                                @if (isset($editdata))
                                    <div class="mr-30 row">
                                        ...
                                        <label for="mute_upon_entry_on">{{__('zoom.Yes')}}</label>
                                    </div>
                                    <div class="mr-30 row">
                                        ...
                                        <label for="mute_upon_entry">{{__('zoom.No')}}</label>
                                    </div>
                                @else
                                    <div class="mr-30 row">
                                        <input type="radio" name="mute_upon_entry" id="mute_upon_entry_on"
                            ...
                            <div class="d-flex radio-btn-flex ml-40">
                                @if (isset($editdata))
                                    <div class="mr-30 row">
                                        ...
                                        <label for="waiting_room_on">{{__('zoom.Yes')}}</label>
                                    </div>
                                    <div class="mr-30 row">
                        ...
                        <div class="col-lg-12 d-flex">
                            ...
                            <div class="col-lg-12 d-flex">
                                <select
                                    ...
                                    name="audio">
                                    <option data-display="{{__('zoom.Student')}}select_section') *"
                                            value="">Select Pakage *
                                    </option>
                                    @if (isset($editdata))
                                        <option
                        ...
                        <div class="col-lg-12 d-flex">
                            ...
                            <div class="col-lg-12 d-flex">
                                <select
                                    ...
                                    @else
                                        <option data-display="{{__('zoom.Package')}} *" value="">Select
                                            Package *
                                        </option>
                                        <option
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12 text-center">
                            @if(empty($user->zoom_api_key_of_user) ||empty($user->zoom_api_serect_of_user))
                                <small class="text-danger">* Please make sure zoom api key setup
                                    successfully. Without zoom api
