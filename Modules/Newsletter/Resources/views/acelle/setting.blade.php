        ...
        <div class="container-fluid p-0">
            <div class="white-box">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row m-0">
                            <div class="col-lg-10 col-xs-6 col-md-6 col-6 g-0 ">
                                <div class="main-title sm_mb_20 sm2_mb_20 md_mb_20 mb-20 ">
                                    ...
                                    <table class="display school-table school-table-style" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($connected)
                                                    <img
                                                        src="{{assetPath('modules/newsletter/green.png')}}"
                                                        width="10px" alt="">
                                                    {{__('newsletter.Connected')}}
                                                @else
                                                    <img src="{{assetPath('modules/newsletter/red.png')}}"
                                                         width="10px" alt="">
                                        ...
                                        @if(count($lists)==0)
                                            <tr>
                                                <td class="text-center"
                                                    colspan="4">{{__('newsletter.No List Found')}}</td>
