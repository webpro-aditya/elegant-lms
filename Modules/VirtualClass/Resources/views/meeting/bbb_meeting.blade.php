                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="white-box">
                                    <div class="row mt-40">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label class="primary_input_label mt-1">{{__('bbb.Topic')}} <span class="required_mark">*</span></label>
                                    ...
                                    <div class="row mt-40">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label class="primary_input_label mt-1">{{__('bbb.Description')}}</label>
                                    ...
                                    <div class="row mt-40">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label class="primary_input_label mt-1">{{__('bbb.Attendee Password')}}
                                    ...
                                    <div class="row mt-40">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label class="primary_input_label mt-1">{{__('bbb.Moderator Password')}}
                                                    <span class="required_mark">*</span></label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row mt-40">
                                        <div class="col-lg-6">
                                            <label class="primary_input_label mt-1">{{__('bbb.Date Of Class')}} <span
                                        ...
                                        <div class="col-lg-6">
                                            <label class="primary_input_label mt-1">{{__('bbb.Time Of Class')}} <span
                                                    class="required_mark">*</span></label>
                                            <input
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                ...
                                                                                {{ old('record',$setting->record) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   id="record" value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('record',$setting->record) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('is_breakout',$setting->is_breakout) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('is_breakout',$setting->is_breakout) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('auto_start_recording',$setting->auto_start_recording) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('auto_start_recording',$setting->auto_start_recording) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('allow_start_stop_recording',$setting->allow_start_stop_recording) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('allow_start_stop_recording',$setting->allow_start_stop_recording) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('webcams_only_for_moderator',$setting->webcams_only_for_moderator) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('webcams_only_for_moderator',$setting->webcams_only_for_moderator) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('mute_on_start',$setting->mute_on_start) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('mute_on_start',$setting->mute_on_start) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('lock_settings_disable_mic',$setting->lock_settings_disable_mic) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('lock_settings_disable_mic',$setting->lock_settings_disable_mic) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('lock_settings_disable_private_chat',$setting->lock_settings_disable_private_chat) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('lock_settings_disable_private_chat',$setting->lock_settings_disable_private_chat) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('lock_settings_disable_public_chat',$setting->lock_settings_disable_public_chat) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('lock_settings_disable_public_chat',$setting->lock_settings_disable_public_chat) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('lock_settings_disable_note',$setting->lock_settings_disable_note) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('lock_settings_disable_note',$setting->lock_settings_disable_note) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('lock_settings_locked_layout',$setting->lock_settings_locked_layout) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('lock_settings_locked_layout',$setting->lock_settings_locked_layout) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('lock_settings_lock_on_join',$setting->lock_settings_lock_on_join) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('lock_settings_lock_on_join',$setting->lock_settings_lock_on_join) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('lock_settings_lock_on_join_configurable',$setting->lock_settings_lock_on_join_configurable) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('lock_settings_lock_on_join_configurable',$setting->lock_settings_lock_on_join_configurable) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('redirect',$setting->redirect) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   id="redirect" value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('redirect',$setting->redirect) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="1"
                                                                                   class="common-radio relationButton" @if(!empty($setting))
                                                                                {{ old('join_via_html5',$setting->join_via_html5) == 1? 'checked': ''}}
                                                                                @endif>
                                                                            <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="">
                                                                            <input type="radio"
                                                                                   ...
                                                                                   value="0"
                                                                                   class="common-radio relationButton"@if(!empty($setting))
                                                                                {{ old('join_via_html5',$setting->join_via_html5) == 0? 'checked': ''}}
                                                                                @endif>
                                                                            <label
