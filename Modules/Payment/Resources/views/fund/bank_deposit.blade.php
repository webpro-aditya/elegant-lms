...
@push('styles')
    <link rel="stylesheet" href="{{assetPath('backend/')}}/approved_deposit.css{{assetVersion()}}">
@endpush
@section('mainContent')
    {!! generateBreadcrumb() !!}
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        {{-- <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#EditFund{{@$value->id}}"  href="#">@lang('lang.edit')</a> --}}
                                                        <a class="dropdown-item" data-bs-toggle="modal"
                                                           data-bs-target="#DeleteFund{{@$value->id}}"
                                                           href="#">@lang('lang.delete')</a>
                                                        <a class="dropdown-item" data-bs-toggle="modal"
                                                           data-bs-target="#ApproveDeposit{{@$value->id}}"
                                                           href="#">@lang('lang.approve')</a>
                                            ...
                                            <form action="{{url('admin/update-fund')}}" method="post">
                                                ...
                                                <div class="row g-0  input-right-icon">
                                                    <div class="col">
                                                        <div class="input-effect">
                                                            <input class="primary-input form-control" id="fund_amount"
                                                                   min="0" type="number" name="fund_amount"
                                                                   value="{{@$value->amount}}">
                                                            <label class="primary_input_label mt-1">@lang('lang.amount')<span
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    ...
                                                    <button class="primary-btn fix-gr-bg"
                                                            type="submit">@lang('lang.update')</button>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mt-40 d-flex justify-content-between">
                                                <button type="button" class="primary-btn tr-bg"
                                                        data-bs-dismiss="modal">@lang('lang.cancel')</button>
                                                <a href="{{ route('admin.depositDelete',@$value->id)}}"
                                                   class="text-light">
                                                    <button class="primary-btn fix-gr-bg"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mt-40 d-flex justify-content-between">
                                                <button type="button" class="primary-btn tr-bg"
                                                        data-bs-dismiss="modal">@lang('lang.cancel')</button>
                                                <a href="{{ route('admin.approveDeposit',@$value->id)}}"
                                                   class="text-light">
                                                    <button class="primary-btn fix-gr-bg"
                                                            type="submit">@lang('lang.approve')</button>
                                                </a>
                                            </div>
                                        </div>
