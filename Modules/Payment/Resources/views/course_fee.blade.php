                    ...
                    <div class="">
                        <div class="row">
                                    ...
                                    <ul class="nav custom_nav" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="General-tab" data-bs-toggle="tab"
                                               href="#General" role="tab" aria-controls="home" aria-selected="true">Flat
                                                Commission</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" id="Company_Information-tab" data-bs-toggle="tab"
                                               href="#Company_Information" role="tab"
                                               aria-controls="Company_Information" aria-selected="false">Specific
                                                Instructor Commission</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" id="SMTP-tab" data-bs-toggle="tab" href="#SMTP"
                                               role="tab"
                                               aria-controls="contact" aria-selected="false">Specific Course
                                                Commission</a>
                                        </li>
                            ...
                            <div class="col-lg-8">
                                ...
                                <!-- Company_Information  -->
                                <div class="tab-pane fade white-box" id="Company_Information" role="tabpanel"
                                     aria-labelledby="Company_Information-tab">
                                    @include('payment::page_components.instractor_commission')
                                </div>

                                <!-- SMTP  -->
                                <div class="tab-pane fade white-box" id="SMTP" role="tabpanel"
