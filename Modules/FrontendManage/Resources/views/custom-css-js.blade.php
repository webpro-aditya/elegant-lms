...
@push('styles')
    <link href="{{assetPath('backend/css/cloudEdit.min.css')}}" rel="stylesheet">
@endpush
@section('mainContent')
                            ...
                            <div role="tabpanel" class="tab-pane fade active show"
                                ...
                                <div class="">
                                    <div class="add-visitor">
                                        ...
                                        <div class="row  ">
                                            <div class="col-lg-12 d-flex justify-content-center align-content-center text-center tooltip-wrapper" data-title=""
                                                 data-original-title="" title="">
                                                <button
                                                    class="primary-btn fix-gr-bg tooltip-wrapper  text-nowrap"
                                                    type="button"
                                                    id="{{!$isDemo?'cssSectionBtn':''}}" data-bs-toggle="tooltip"
                                                    title="{{$tooltip}}"
                                                >
                                                    <i class="ti-check"></i>
                                            ...
                                            <div class="col-xl-12">
                                                <div class="primary_input mb-35">
                                                    <div class="tab-content">
                                                        <div class="window js">
                                                            <pre id="js">{!! $js !!}</pre>
                                                            <span class="windowLabel"
                                                                  id="jsLabel">JavaScript/jQuery</span>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row  ">
                                            <div class="col-lg-12 d-flex justify-content-center align-content-center text-center tooltip-wrapper" data-title=""
                                                ...
                                                <button
                                                    class="primary-btn fix-gr-bg tooltip-wrapper  text-nowrap"
                                                    type="button"
                                                    id="{{!$isDemo?'jsSectionBtn':''}}" data-bs-toggle="tooltip"
                                                    title="{{$tooltip}}"
                                                >
                                                    <i class="ti-check"></i>
                                                    {{__('common.Update')}} </button>
...
@push('scripts')
    <script src="{{assetPath('backend/js/ace/ace.js')}}" type="text/javascript" charset="utf-8"></script>
    <script src="{{assetPath('backend/js/cloudEdit.js')}}" type="text/javascript" charset="utf-8"></script>
    <script>
