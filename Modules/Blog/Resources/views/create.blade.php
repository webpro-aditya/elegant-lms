                                ...
                                <form action="{{route('blogs.store')}}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="primary_input mb-25">
                                                            <label class="primary_input_label d-flex"
                                                                ...
                                                                @includeIf('aicontent::inc.button' , ['selected_template' => 10,'slug'=>'blog-title'])
                                                            </label>
                                                            <input
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="primary_input mb-35">
                                                            <label class="primary_input_label d-flex"
                                                                ...
                                                                @includeIf('aicontent::inc.button' , ['selected_template' => 11,'slug'=>'blog-details'])
                                                            </label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="">  {{__('blog.Minutes to read')}}
                                                </label>
                                                <input class="primary_input_field  " name="minutes"
                                                       placeholder="-"
                                                       type="number"
                                                       min="0"
                                                       value="{{old('minutes')}}">
                                        ...
                                        <div class="col-xl-6 courseBox mb-25" id=" ">
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-xl-4">
                                            ...
                                            {{--                                                                   id="document_file_2">--}}
                                            {{--                                                        </button>--}}
                                            {{--                                                        <button type="button" data-table="blogs"--}}
                                            {{--                                                                data-name="image"--}}
                                            {{--                                                                data-id="0"--}}
                                            {{--                                                                data-label=".labelTitle"--}}
                                            {{--                                                                class="primary-btn small fix-gr-bg px-3 removeImage">--}}
                                            {{--                                                            x--}}
                                            {{--                                                        </button>--}}
                                            {{--                                                    </div>--}}
                                            {{--                                                </div>--}}
...
@push('scripts')
    ...
    <script src="{{assetPath('modules/blog/taginput/taginput/tagsinput.js')}}"></script>
    <script src="{{assetPath('js/wordcut.min.js')}}"></script>
    <script src="{{assetPath('backend/js/summernote-word-count.js')}}"></script>
@endpush
