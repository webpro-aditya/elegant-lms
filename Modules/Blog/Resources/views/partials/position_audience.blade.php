            ...
            <div class="col-md-6 mb-25">
                <label class="primary_checkbox d-flex mr-12"
                    ...
                    <input type="radio"
                           ...
                           value="1">
                    <span
                        class="checkmark me-2"></span> {{__('common.All')}}
                </label>
            </div>
            <div class="col-md-6  mb-25">
                <label class="primary_checkbox d-flex mr-12"
                    ...
                    <input type="radio"
                           ...
                           name="position_audience"
                           data-bs-toggle="modal" data-bs-target="#selectPositionBranch"
                           value="2">
                    <span
                        class="checkmark me-2"></span> {{__('blog.Specify')}}
                </label>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <div class="org_table ">
                            ...
                            <table id="" class="table  branchList ">
                                ...
                                @foreach($positions as $position)
                                    <tr>
                                        <td class="text-start activePosition">
                                            {{$position->name}}
                                        </td>
                                        <td class="">
                                            <label class="primary_checkbox d-flex mr-12">
                ...
                <div class="mt-40 d-flex justify-content-center">
                    <button class="primary-btn float-end fix-gr-bg"
