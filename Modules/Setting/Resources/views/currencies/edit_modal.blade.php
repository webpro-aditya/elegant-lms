                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="primary_input mb-25">
                            ...
                            <input name="name" class="primary_input_field name" value="{{ $currency->name }}"
                    ...
                    <div class="col-xl-12">
                        <div class="primary_input mb-25">
                            <label class="primary_input_label" for="">{{ __('setting.Code') }} <strong
                                    class="text-danger">*</strong></label>
                            <input name="code" class="primary_input_field name" value="{{ $currency->code }}"
                    ...
                    <div class="col-xl-12">
                        <div class="primary_input mb-25">
                            <label class="primary_input_label" for="">{{ __('setting.Symbol') }} <strong
                                    class="text-danger">*</strong></label>
                            <input name="symbol" class="primary_input_field name" value="{{ $currency->symbol }}"
                    ...
                    <div class="col-xl-12">
                        <div class="primary_input mb-25">
                            <label class="primary_input_label" for="">{{ __('setting.Conversion Rate') }}
                                1 {{Settings('currency_code')}} = ? <strong class="text-danger">*</strong></label>
                            <input name="conversion_rate" class="primary_input_field name"
                                   value="{{ $currency->conversion_rate }}" placeholder="1" type="text" required>
                        </div>
                    </div>
