...
(function ($) {
    ...
    AIZ.uploader = {
        ...
        removeAttachment: function () {
            $(document).on("click", '.remove-attachment', function () {
                ...
                var selected = $(this)
                    ...
                    .prev('[data-bs-toggle="aizuploader"]')
                    .find(".selected-files")
                    .val()
                    .split(",")
                    .map(Number);
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var html =
                            ...
                            // "." +
                            // data[i].extension +
                            // '" class="dropdown-item"><i class="la la-download me-2"></i>Download</a>' +
                            // '<a href="#" class="dropdown-item aiz-uploader-delete" data-id="' +
                            // data[i].id +
                            // '"><i class="la la-trash me-2"></i>Delete</a>' +
                            // "</div>" +
                            // "</div>" +
        ...
        trigger: function (
            ...
            $.post(
                ...
                function (data) {
                    ...
                    $('[data-bs-toggle="aizUploaderAddSelected"]').on(
                        "click",
                        function () {
                            if (from === "input") {
        ...
        initForInput: function () {
            $(document).on("click", '[data-bs-toggle="aizuploader"]', function (e) {
                if (e.detail === 1) {
                    var elem = $(this);
        ...
        previewGenerate: function () {
            $('[data-bs-toggle="aizuploader"]').each(function () {
                var $this = $(this);
    ...
    AIZ.plugins = {
        metismenu: function () {
            $('[data-bs-toggle="aiz-side-menu"]').metisMenu();
        },
            ...
            $.notify(
                ...
                },
                {
                    ...
                    template:
                        ...
                        '<button type="button" aria-hidden="true" data-notify="dismiss"  class="btn-close" ><i class="las la-times"></i></button>' +
        ...
        tooltip: function () {
            $('body').tooltip({selector: '[data-bs-toggle="tooltip"]'}).click(function () {
    ...
    AIZ.extra = {
        ...
        mobileNavToggle: function () {
            ...
            $('[data-bs-toggle="aiz-mobile-nav"]').on("click", function () {
        ...
        initActiveMenu: function () {
            $('[data-bs-toggle="aiz-side-menu"] a').each(function () {
        ...
        classToggle: function () {
            $(document).on('click', '[data-bs-toggle="class-toggle"]', function () {
                var $this = $(this);
                var target = $this.data("target");
        ...
        collapseSidebar: function () {
            $(document).on('click', '[data-bs-toggle="collapse-sidebar"]', function (i, el) {
                var $this = $(this);
                var target = $(this).data("target");
                var sameTriggers = $(this).data("siblings");

                // var showOverlay = $this.data('overlay');
                // var overlayMarkup = '<div class="overlay overlay-fixed dark c-pointer" data-bs-toggle="collapse-sidebar" data-bs-toggle="'+target+'"></div>';
        ...
        addMore: function () {
            $('[data-bs-toggle="add-more"]').each(function () {
                var $this = $(this);
