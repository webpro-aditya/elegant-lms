    ...
    <form class="" action="{{ route('socialCreditional') }}" method="post">
            ...
            <div class="col-lg-2">
                <div class="primary_input">
                    ...
                    <select class="primary_select mb-25" name="googleLogin" id="googleLogin">
                        <option value="1"
                                @if ($setting->googleLogin==1) selected @endif>{{ __('common.Enable') }}</option>
                        <option value="0"
                                @if ($setting->googleLogin==0) selected @endif>{{ __('common.Disable') }}</option>
                    </select>
                </div>
            </div>
            <div class="col-xl-5">
                <div class="primary_input mb-25">
                    ...
                    <input class="primary_input_field" placeholder="-" type="text" name="google_client"
                           value="{{@$setting->google_client }}">
                </div>
            </div>
            <div class="col-xl-5">
                <div class="primary_input mb-25">
                    <label class="primary_input_label" for="">{{ __('setting.Google Secret Key') }} *</label>
                    <input class="primary_input_field" placeholder="-" type="text" name="google_secret"
        ...
        <div class="row">
            ...
            <div class="col-xl-5">
                <div class="primary_input mb-25">
                    ...
                    <input class="primary_input_field" placeholder="-" type="text" name="facebook_client"
                           value="{{@$setting->facebook_client }}">
                </div>
            </div>
            <div class="col-xl-5">
                <div class="primary_input mb-25">
                    <label class="primary_input_label" for="">{{ __('setting.Facebook Secret Key') }} *</label>
                    <input class="primary_input_field" placeholder="-" type="text" name="facebook_secret"
                           value="{{@$setting->facebook_secret }}">
                </div>
            </div>
        </div>
        ...
        <div id="TexttoLocal_Settings" class="sms_ption">
            ...
            <div class="submit_btn text-center mb-100 pt_15">
                <button class="primary-btn fix-gr-bg" data-bs-toggle="tooltip" title="{{$tooltip}}" type="submit"><i
