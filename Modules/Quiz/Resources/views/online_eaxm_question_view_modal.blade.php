        ...
        <div class="row mt-25">
            <div class="col-lg-12">
                <div class="input-effect">
                    ...
                    <label class="primary_input_label mt-1">{{__('quiz.Question')}} {{__('coupons.Title')}}</label>
            ...
            <div class="row  mt-25">
                <div class="col-lg-12">
                    <div class="input-effect">
                        ...
                        <label class="primary_input_label mt-1">@lang('lang.suitable_words')</label>
                        <span class="focus-border textarea"></span>
                    </div>
                </div>
            </div>
...
@push('scripts')
    <script src="{{assetPath('backend/')}}/js/main.js"></script>
@endpush
