...
return [
    ...
    |
    */
    'consumer_key' => getPaymentEnv('PESAPAL_KEY'),
   ...
   |
   */
    'consumer_secret' => getPaymentEnv('PESAPAL_SECRET'),
   ...
   |
   */
    'is_live' => getPaymentEnv('PESAPAL_IS_LIVE', true),
   ...
   |
   */
    'callback_url' => getPaymentEnv('PESAPAL_CALLBACK'),
];
