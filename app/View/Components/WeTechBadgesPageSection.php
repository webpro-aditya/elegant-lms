...
class WeTechBadgesPageSection extends Component
{
    ...
    public function render()
    {
        ...
        $open_courses = Course::where('required_type', 1)
        ...
        return view(theme('components.we-tech-badges-page-section'), $data, compact('sliders', 'blogs', 'open_courses', 'totalCertificate', 'totalBadges', 'leaderboards', 'types', 'badges'));
    }
