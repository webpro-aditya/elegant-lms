...
//            $filePath =config('app.has_public_folder') ? 'public/uploads/file/' : 'uploads/file/';
            ...
            if (isset($file[2])) {
                ...
                $finalLocation = $filePath . $current_date;
...
//        $filePath =config('app.has_public_folder') ? 'public/uploads/file/' : 'uploads/file/';
    ...
    public function isFileAllow($ext)
    {
        $notAllow = ['exe', 'php', 'js', 'sh', 'bin'];
