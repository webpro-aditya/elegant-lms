(function ($) {
    var defaults = {
        ...
        // plugin texts
        texts: {
            placeholder: window.jsLang('data_select_options'), // text to use in dummy input
            search: window.jsLang('data_search'),
            selectedOptions: window.jsLang('data_selected'),
            selectAll: window.jsLang('data_select_all'),
            unselectAll: window.jsLang('data_unselect_all'),
            noneSelected: window.jsLang('data_unselect_all'),
            data_none_selected: window.jsLang('data_none_selected')
        },
        ...
        }, // fires when the placeholder txt is updated
    };
    ...
    MultiSelect.prototype = {
        ...
        _addOption: function (container, option) {
            ...
            thisOption.prepend(`<span class="checkmark"></span>`);
