...
(function (jQuery, ytp) {
    ...
    jQuery.mbYTPlayer = {
        name: 'jquery.mb.YTPlayer', version: '3.3.9', build: '7619', author: 'Matteo Bicocchi (pupunzi)', apiKey: '',
        ...
        }, controlBar: null, locationProtocol: 'https:',
                            ...
                            events: {
                                'onReady': function (event) {
                                    ...
                                    YTPlayer.player.loadVideoById({
                                        videoId: YTPlayer.videoID.toString(), suggestedQuality: YTPlayer.opt.quality
                                    });
                                ...
                                'onStateChange': function (event) {
                                    ...
                                    switch (state) {
                                        ...
                                        case 1:
                                            ...
                                            if (YTPlayer.isPlayer) YTPlayer.inlinePlayButton.hide();
                                        ...
                                        case 2:
                                            ...
                                            if (YTPlayer.isPlayer) YTPlayer.inlinePlayButton.show();
                                            break;
        ...
        getDataFromAPI: function (YTPlayer) {
            ...
            if (YTPlayer.videoData) {
                setTimeout(function () {
                    ...
                    for (let x in YTPlayer.videoData) if (YTPlayer.videoData.hasOwnProperty(x)) YTPData.prop[x] = YTPlayer.videoData[x];
        ...
        changeVideo: function (opt) {
            ...
            jQuery(YTPlayer.playerEl).CSSAnimate({
                ...
                $YTPlayer.YTPGetPlayer().loadVideoById({
                    videoId: YTPlayer.videoID, suggestedQuality: YTPlayer.opt.quality
                });
        ...
        pause: function () {
            ...
            if (YTPlayer.opt.abundance < .2) this.YTPSetAbundance(.2);
        ...
        toggleVolume: function () {
            ...
            if (YTPlayer.isMute) {
                if (!jQuery.mbBrowser.mobile) this.YTPSetVolume(YTPlayer.opt.vol);
                this.YTPUnmute()
            } else {
                this.YTPMute()
            }
            ...
            if (YTPlayer.opt.mask) {
                if (typeof YTPlayer.opt.mask == 'string') {
                    ...
                    for (let time in YTPlayer.opt.mask) {
                        ...
                        if (YTPlayer.opt.mask[time]) img = jQuery('<img/>').attr('src', YTPlayer.opt.mask[time])
                    }
                    ...
                    $YTPlayer.on('YTPTime.mask', function (e) {
                        ...
                        for (let time in YTPlayer.opt.mask) {
                            if (e.time === time) if (!YTPlayer.opt.mask[time]) {
        ...
        toggleMask: function () {
            ...
            let $YTPlayer = jQuery(YTPlayer);
            if (YTPlayer.hasMask) $YTPlayer.YTPRemoveMask(); else $YTPlayer.YTPAddMask();
            return this
        },
        ...
        buildControls: function (YTPlayer) {
            ...
            volumeBar.simpleSlider({
                initialval: YTPlayer.opt.vol, scale: 100, orientation: 'h', callback: function (el) {
        ...
        checkForStart: function (YTPlayer) {
            ...
            if (YTPlayer.overlay) if (YTPlayer.opt.addRaster) {
                ...
                YTPlayer.overlay.removeClass(function (index, classNames) {
                    ...
                    let current_classes = classNames.split(' '), // array of classes which are to be removed
                        classes_to_remove = [];
            ...
            YTPlayer.checkForStartAt = setInterval(function () {
                ...
                if (jQuery.mbBrowser.mobile) canPlayVideo = true;
        ...
        setAbundance: function (val, updateOptions) {
            let YTPlayer = this.get(0);
            let $YTPlayer = this;
            if (updateOptions) YTPlayer.opt.abundance = val;
...
jQuery.mbBrowser = jQuery.mbBrowser;
jQuery.mbBrowser.versionCompare = function (a, e) {
...
function setFilter(d, a, b) {
    var c = uncamel(a), g = jQuery.mbBrowser.mozilla ? "" : jQuery.CSS.sfx;
...
jQuery.CSS = {
    ...
    normalizeCss: function (d) {
        ...
        jQuery.mbBrowser.webkit || jQuery.mbBrowser.opera ? jQuery.CSS.sfx = "-webkit-" : jQuery.mbBrowser.mozilla ? jQuery.CSS.sfx = "-moz-" : jQuery.mbBrowser.msie && (jQuery.CSS.sfx = "-ms-");
        jQuery.CSS.sfx = "";
        for (var b in a) {
            "transform" === b && (a[jQuery.CSS.sfx + "transform"] = a[b], delete a[b]);
            "transform-origin" === b && (a[jQuery.CSS.sfx + "transform-origin"] = d[b], delete a[b]);
            "filter" !== b || jQuery.mbBrowser.mozilla || (a[jQuery.CSS.sfx + "filter"] = d[b], delete a[b]);
    ...
    getProp: function (d) {
        var a = [], b;
        for (b in d) 0 > a.indexOf(b) && a.push(uncamel(b));
        return a.join(",")
    },
    animate: function (d, a, b, c, g) {
        return this.each(function () {
            ...
            if (e.CSSAIsRunning && e.eventType == k.type && !jQuery.mbBrowser.msie && 9 >= jQuery.mbBrowser.version) e.CSSqueue = function () {
                ...
                if ("string" == typeof a) for (var l in jQuery.fx.speeds) if (a == l) {
                ...
                if (jQuery.support.CSStransition) {
                    ...
                    for (f in d) "transform" === f && delete d[f], "filter" === f && delete d[f], "transform-origin" === f && delete d[f], "auto" === d[f] && delete d[f], "x" === f && (k = d[f], l = "left", d[l] = k, delete d[f]), "y" === f && (k = d[f], l = "top", d[l] = k, delete d[f]), "-ms-transform" !== f && "-ms-filter" !== f || delete d[f];
...
(function (b) {
    b.simpleSlider = {
        defaults: {initialval: 0, maxval: 100, orientation: "h", readonly: !1, callback: !1}, events: {
            start: b.mbBrowser.mobile ? "touchstart" : "mousedown",
            end: b.mbBrowser.mobile ? "touchend" : "mouseup",
            move: b.mbBrowser.mobile ? "touchmove" : "mousemove"
        }, init: function (d) {
            return this.each(function () {
                var a = this, c = b(a);
                c.addClass("simpleSlider");
                a.opt = {};
                b.extend(a.opt, b.simpleSlider.defaults, d);
                b.extend(a.opt, c.data());
                var f = "h" === a.opt.orientation ? "horizontal" : "vertical";
                f = b("<div/>").addClass("level").addClass(f);
                c.prepend(f);
                a.level = f;
                c.css({cursor: "default"});
                "auto" == a.opt.maxval && (a.opt.maxval = b(a).outerWidth());
                c.updateSliderVal();
                a.opt.readonly || (c.on(b.simpleSlider.events.start, function (e) {
                    b.mbBrowser.mobile && (e = e.changedTouches[0]);
                    a.canSlide = !0;
                    c.updateSliderVal(e);
                    "h" === a.opt.orientation ? c.css({cursor: "col-resize"}) : c.css({cursor: "row-resize"});
                    a.lastVal = a.val;
                    b.mbBrowser.mobile || (e.preventDefault(), e.stopPropagation())
                }), b(document).on(b.simpleSlider.events.move, function (e) {
                    b.mbBrowser.mobile && (e = e.changedTouches[0]);
                    a.canSlide && (b(document).css({cursor: "default"}), c.updateSliderVal(e), b.mbBrowser.mobile || (e.preventDefault(), e.stopPropagation()))
        ...
        }, updateSliderVal: function (d) {
            var a = this.get(0);
            if (a.opt) {
                a.opt.initialval = "number" == typeof a.opt.initialval ? a.opt.initialval : a.opt.initialval(a);
                var c = b(a).outerWidth(), f = b(a).outerHeight();
                a.x = "object" == typeof d ? d.clientX + document.body.scrollLeft - this.offset().left : "number" == typeof d ? d * c / a.opt.maxval : a.opt.initialval * c / a.opt.maxval;
                a.y = "object" == typeof d ? d.clientY + document.body.scrollTop - this.offset().top : "number" == typeof d ? (a.opt.maxval - a.opt.initialval - d) * f / a.opt.maxval : a.opt.initialval * f / a.opt.maxval;
                a.y = this.outerHeight() - a.y;
                a.scaleX = a.x * a.opt.maxval / c;
                a.scaleY = a.y * a.opt.maxval / f;
                a.outOfRangeX = a.scaleX > a.opt.maxval ? a.scaleX - a.opt.maxval : 0 > a.scaleX ? a.scaleX : 0;
                a.outOfRangeY = a.scaleY > a.opt.maxval ? a.scaleY - a.opt.maxval : 0 > a.scaleY ? a.scaleY : 0;
                a.outOfRange = "h" === a.opt.orientation ? a.outOfRangeX : a.outOfRangeY;
                a.value = "undefined" != typeof d ? "h" === a.opt.orientation ? a.x >= this.outerWidth() ? a.opt.maxval : 0 >= a.x ? 0 : a.scaleX : a.y >= this.outerHeight() ? a.opt.maxval : 0 >= a.y ? 0 : a.scaleY : "h" === a.opt.orientation ? a.scaleX : a.scaleY;
                "h" === a.opt.orientation ? a.level.width(Math.floor(100 * a.x / c) + "%") : a.level.height(Math.floor(100 * a.y / f));
                a.lastVal === a.value && ("h" === a.opt.orientation && (a.x >= this.outerWidth() || 0 >= a.x) || "h" !== a.opt.orientation && (a.y >= this.outerHeight() || 0 >= a.y)) || ("function" === typeof a.opt.callback && a.opt.callback(a), a.lastVal = a.value)
            }
        }
    };
