    ...
    return function (e) {
        ...
        class i {
            ...
            addNode(e, t, n, i, s, o, l, c, d = !1) {
                ...
                let total = $('.' + e + "Node").length;
                let qusHeight = ($('.qusNode').length + 1) * 80;
                let ansHeight = $('.ansNode').length * 80;

                let typeClass, top, left, right, bottom, custom_style;
                let canvasHeight = qusHeight > ansHeight ? qusHeight : ansHeight;


                // console.log(qusHeight, ansHeight, canvasHeight)
                if (e == 'qus') {
                    typeClass = 'qusNode';
                    top = total * 70
                    left = 0
                ...
                $('#drawflow').css('height', canvasHeight + 'px')
